...
SCALE = 1000.0
ITERS = 64000
K_NOIMPROVE = 12000  # scaled with the 4x longer runs
SP_TIME = 120.0
EPS = 1.0e-6
...
def main() -> int:
    ...
    with (OUT / "d7_raw_runs.csv").open("w", newline="", encoding="utf-8") as h:
    ...
    summary = {
        "schema": "resetp.public-algo-diag.d7.v1",
    ...
    (OUT / "d7_summary.json").write_text(
