...
`cn-prd-150c-01-V2-LOCATIONS` 共有 150 名客户在已保存的“all generated cross-depot moves”筛查中距离变化为负。现有动作生成器围绕这些客户生成 26363 个跨车场候选，其中 567 个进入完整评价，0 个通过完整模型，0 个相对登记起点的罚后目标更优。完整真值复核执行 567 次，耗时 257.143 秒，进程峰值内存 1349.062 MB。
