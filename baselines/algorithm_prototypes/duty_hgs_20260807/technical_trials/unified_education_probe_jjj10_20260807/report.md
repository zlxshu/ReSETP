...
`cn-jjj-10c-01-V2-LOCATIONS` 从登记合法起点出发，完整邻域教育共执行 4 轮，最终服务 10/10 个客户、完成需求量 3196.000/3196.000 千克，完整检查违规 0。成本由 599.770658 元变为 561.147506 元。逐候选真值复核开关为 `True`，实际复核 89 次。
