"""Shared paths, frozen-input verification, and artifact helpers."""
...
for relative in (
    ...
    "baselines/algorithm_prototypes/unordered_route_pair_mip_20260725",
    "baselines/algorithm_prototypes/dual_guided_resource_order_20260725",
