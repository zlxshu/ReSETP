...
|---|---:|---:|---:|---:|---:|---|
| carbon_vs_ablation | 3 | 0.0000 | 0.0000 | 0/3/0 | 1 | all_zero |
| carbon_vs_lns | 3 | -9.5949 | -36.4042 | 1/2/0 | 0.5 | scipy_wilcoxon_less |
| carbon_vs_throughput | 3 | 0.0000 | 0.0000 | 0/3/0 | 1 | all_zero |
...
- Data dir: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data`
- Raw rows: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data/raw_runs.csv`
- Carbon pair summary: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data/carbon_pair_summary.csv`
- Carbon comparison summary: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data/carbon_comparison_summary.csv`
- Stage decision: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data/stage_decision.json`
- Artifact hashes: `baselines/e2_alns/carbon_aware_operator_probe_smoke_data/artifact_hashes.json`
- Report: `baselines/e2_alns/carbon_aware_operator_probe_smoke.md`
