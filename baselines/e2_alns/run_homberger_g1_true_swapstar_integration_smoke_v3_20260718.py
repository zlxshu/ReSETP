#!/usr/bin/env python3
"""Re-attest the C-instance integration smoke after the R-stagnation fix."""
...
OUTPUT = (
    REPO
    / "baselines/e2_alns"
    / "homberger_g1_true_swapstar_integration_smoke_v3_20260718"
)
...
def main() -> int:
    ...
    metadata["schema_version"] = (
        "resetp.e2.homberger-g1-true-swapstar-integration-smoke.v3"
    )
    metadata["supersedes"] = (
        "baselines/e2_alns/"
    ...
    metadata["reason"] = (
        "re-attest the same C1 activation and exact-budget contract against "
        "the current source after the R-stagnation eligibility correction"
    )
    ...
    contract["budget_change_from_v2"] = 0
    contract["performance_comparison"] = False
