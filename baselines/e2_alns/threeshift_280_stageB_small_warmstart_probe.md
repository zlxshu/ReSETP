...
- Mean ALNS EV route share: `0.7908498589533073`
- EV retained: `True`
- Carbon ablation significant: `False` (p_less=`0.40625`)

## ALNS vs Baselines

| baseline | pairs | wins/ties/losses | mean gap % | p_less | significant win |
|---|---:|---:|---:|---:|---|
| GA | 6 | 6/0/0 | -21.7114 | 0.015625 | True |
| LNS | 6 | 6/0/0 | -19.5386 | 0.015625 | True |
| PSO | 6 | 6/0/0 | -21.7114 | 0.015625 | True |
| VNS | 6 | 6/0/0 | -21.7114 | 0.015625 | True |

## Artifacts

- Data dir: `baselines/e2_alns/threeshift_280_stageB_small_warmstart_probe_data`
- Report: `baselines/e2_alns/threeshift_280_stageB_small_warmstart_probe.md`
...
- Raw rows: `baselines/e2_alns/threeshift_280_stageB_small_warmstart_probe_data/raw_runs.csv`
- Baseline pairs: `baselines/e2_alns/threeshift_280_stageB_small_warmstart_probe_data/paired_vs_baselines.csv`
- Ablation pairs: `baselines/e2_alns/threeshift_280_stageB_small_warmstart_probe_data/paired_vs_ablation.csv`
