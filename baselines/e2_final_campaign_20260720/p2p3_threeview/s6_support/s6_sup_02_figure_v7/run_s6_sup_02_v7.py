...
def plot_figure4() -> dict[str, Any]:
    ...
    fig.subplots_adjust(left=0.16, right=0.985, bottom=0.19, top=0.975)
...
def main() -> int:
    ...
    report = [
        ...
        "",
        "图4恢复为连续单轴纵轴，曲线数据、预注册种子和单调 best-so-far 口径不变；不再使用断轴或上下分离坐标轴。旧 `figure4_curve_data_v2.csv` 仅作为历史文件记录哈希，没有被重新用于当前图，以免越过 S3-TRAJ 的最新批准口径。",
        "",
