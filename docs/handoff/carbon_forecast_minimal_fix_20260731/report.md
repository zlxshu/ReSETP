...
> **历史错误记录，已被取代。** 本任务删除预测字段的方向在后续代码复核中被判错，用户已批准撤销。
> 2026-08-01 当前有效结论与执行证据见
> `docs/handoff/memory/carbon_forecast_semantics_restore_20260801.md`。本目录保留 before/after 文件用于审计，
> 不得再把 `paper_main.after.tex` 当作当前论文版本。
