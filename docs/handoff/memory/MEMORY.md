...
- [paper_v2 论文数据核验（2026-08-27）](../paper_v2_data_audit_20260827/report.md) — 逐表把 PDF 数字追到结果包：数字未编造、均值复算闭合，但协同/公平两表因两臂算力不对等而证伪，消融三臂逐位相同=机制零效应，49 包全缺 artifact_hashes.json，且该 PDF 写在已判定退役只读的文件上
