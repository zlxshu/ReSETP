...
- [Project PRD execution v2](project-prd-execution-v2.md) — 全项目 PRD/施工图 v2: 宏观路线、E2重点摸排、E1-E7 PDCA、DR-ALNS接入、记录制度、风险门槛; C1已判5174同值平台为ARTIFICIAL_HOMOGENIZATION，G4/G5冻结
