...
def test_worker_learned_destroy_branch_returns_customer_features(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert response["per_customer_features"] == response["customer_features"]
...
def test_pilot20_verdict_halts_on_worker_integrity_drift() -> None:
    rows = [
        {
            "algorithm": "learned_destroy",
            "bundle": "models/data_bundle/generated_instances/E-UK25_08__curric_d2_s3_seed8_24h",
            "scale": "25c",
            "seed": 1,
            "best_obj": 90.0,
            "violation_count": 0,
            "worker_integrity_ok": False,
        },
        {
            "algorithm": "operator_select",
            "bundle": "models/data_bundle/generated_instances/E-UK25_08__curric_d2_s3_seed8_24h",
            "scale": "25c",
            "seed": 1,
            "best_obj": 100.0,
    ...
    assert verdict["status"] == "HALT_WORKER_INTEGRITY"
    assert verdict["required_worker_numpy"] == REQUIRED_WORKER_NUMPY
