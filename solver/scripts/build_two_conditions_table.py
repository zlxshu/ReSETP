...
ROWS = [
    ...
    (r"\makecell{增设午间谷段\\碳价0.20}", GRID_DIR / "midday/P=0.2/MT-HGS", REPO_ROOT / "solver/reports/carbon_min_two_conditions_20260910/midday_P0.2"),
    ...
    (r"\makecell{增设午间谷段\\碳价1.00}", GRID_DIR / "midday/P=1.0/MT-HGS", REPO_ROOT / "solver/reports/charging_arrangements_midday_P1.0_20260909/carbon_min"),
]
