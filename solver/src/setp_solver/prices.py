...
Q_capacity = 1600.0  # kg, 车辆载重容量。本研究算例取 ScenarioConfig.vehicle_capacity=1600, 非 Goeke 原 Q=3650; 以当前算例生成值为准。参考文献: GOEKE D, SCHNEIDER M. Routing a mixed fleet of electric and conventional vehicles[J]. European Journal of Operational Research, 2015, 245(1): 81-99. DOI:10.1016/j.ejor.2015.01.049.
v_speed_ms = 25.0  # m/s, 固定速度=90 km/h。Goeke(2015)6.2 节采用 PRP 速度上限 90 km/h 以保证纯油车时间窗可行。参考文献: GOEKE D, SCHNEIDER M. Routing a mixed fleet of electric and conventional vehicles[J]. European Journal of Operational Research, 2015, 245(1): 81-99. DOI:10.1016/j.ejor.2015.01.049.
...
B_battery_kwh = 80.0  # kWh, 电池容量。Goeke(2015)Table 4 原值, 源 Davis & Figliozzi 2013。参考文献: GOEKE D, SCHNEIDER M. Routing a mixed fleet of electric and conventional vehicles[J]. European Journal of Operational Research, 2015, 245(1): 81-99. DOI:10.1016/j.ejor.2015.01.049.
