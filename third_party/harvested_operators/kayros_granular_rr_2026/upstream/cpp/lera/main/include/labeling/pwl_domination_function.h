...
#ifndef NETWORKS2019_PWL_DOMINATION_FUNCTION_H
#define NETWORKS2019_PWL_DOMINATION_FUNCTION_H
...
public:
	...
	// Returns: The smallest interval [min_x, max_x] such that dom(f) \subseteq [min_x, max_x].
