...
from setp_hgs_kernel.constants import MAX_VALUE
from setp_hgs_kernel.exceptions import ScalingWarning
from setp_hgs_kernel.solve import SolveParams, solve

if TYPE_CHECKING:
    from setp_hgs_kernel.Result import Result
    from setp_hgs_kernel.stop import StoppingCriterion
...
class Profile:
    ...
    :class:`~setp_hgs_kernel._setp_hgs_kernel.VehicleType` is associated with a routing profile.
    """
...
class Model:
    ...
    def vehicle_types(self) -> list[VehicleType]:
        ...
        :meth:`~setp_hgs_kernel._setp_hgs_kernel.Route.vehicle_type()` that can be used to index
        these vehicle types.
        """
    ...
    def from_data(cls, data: ProblemData) -> "Model":
        ...
        .. tip::
           ...
           it is faster to directly call :meth:`~setp_hgs_kernel.solve.solve`.
    ...
    def add_client(
        ...
        *,
        ...
        created :class:`~setp_hgs_kernel._setp_hgs_kernel.Client` instance.
    ...
    def add_depot(
        ...
        *,
        ...
        created :class:`~setp_hgs_kernel._setp_hgs_kernel.Depot` instance.
        """
    ...
    def add_vehicle_type(
        ...
        *,
        ...
        created :class:`~setp_hgs_kernel._setp_hgs_kernel.VehicleType` instance.
    ...
    def data(self, missing_value: int = MAX_VALUE) -> ProblemData:
        """
        Creates and returns a :class:`~setp_hgs_kernel._setp_hgs_kernel.ProblemData` instance
        ...
        missing_value
            ...
            :const:`~setp_hgs_kernel.constants.MAX_VALUE`, a large number. Note that this
            value cannot exceed :const:`~setp_hgs_kernel.constants.MAX_VALUE`.
        """
        locs = self.locations
    ...
    def solve(
        ...
        missing_value
            Distance and duration value to use for missing edges. Defaults to
            :const:`~setp_hgs_kernel.constants.MAX_VALUE`, a large number.
