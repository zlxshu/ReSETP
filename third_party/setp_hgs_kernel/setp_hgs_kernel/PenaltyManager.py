...
from setp_hgs_kernel._setp_hgs_kernel import CostEvaluator, ProblemData, Solution
from setp_hgs_kernel.exceptions import PenaltyBoundWarning
...
class PenaltyManager:
    ...
    initial_penalties
        ...
        [:attr:`~setp_hgs_kernel.PenaltyManager.PenaltyParams.min_penalty`,
        :attr:`~setp_hgs_kernel.PenaltyManager.PenaltyParams.max_penalty`].
    params
