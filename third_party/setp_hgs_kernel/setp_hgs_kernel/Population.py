...
from setp_hgs_kernel._setp_hgs_kernel import PopulationParams, SubPopulation

if TYPE_CHECKING:
    from setp_hgs_kernel._setp_hgs_kernel import CostEvaluator, RandomNumberGenerator, Solution
...
class Population:
    ...
    diversity_op
        ...
        a look at :mod:`setp_hgs_kernel.diversity` for available operators.
    params
    ...
    def add(self, solution: Solution, cost_evaluator: CostEvaluator):
        ...
        .. note::
           ...
           :attr:`~setp_hgs_kernel.Population.PopulationParams.max_pop_size`.
