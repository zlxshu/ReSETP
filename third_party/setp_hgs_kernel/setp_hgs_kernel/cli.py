...
from setp_hgs_kernel import ProblemData, Result, SolveParams, solve
from setp_hgs_kernel.read import ROUND_FUNCS, read
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(prog="setp_hgs_kernel", description=description)
