...
// For printing.
template <setp_hgs_kernel::MeasureType Type, setp_hgs_kernel::NumberType Value>
std::ostream &operator<<(std::ostream &out,
                         setp_hgs_kernel::Measure<Type, Value> const measure)
{
...
template <setp_hgs_kernel::MeasureType Type, setp_hgs_kernel::NumberType Value>
struct std::hash<setp_hgs_kernel::Measure<Type, Value>>
{
    size_t operator()(setp_hgs_kernel::Measure<Type, Value> const measure) const
    {
...
template <setp_hgs_kernel::MeasureType Type, setp_hgs_kernel::NumberType Value>
class std::numeric_limits<setp_hgs_kernel::Measure<Type, Value>>
{
public:
    static setp_hgs_kernel::Measure<Type, Value> max()
    {
        return std::numeric_limits<Value>::max();
    }

    static setp_hgs_kernel::Measure<Type, Value> min()
    {
