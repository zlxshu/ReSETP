...
using setp_hgs_kernel::Distance;
using setp_hgs_kernel::Duration;
using setp_hgs_kernel::Load;
...
std::pair<setp_hgs_kernel::Coordinate, setp_hgs_kernel::Coordinate> const &
