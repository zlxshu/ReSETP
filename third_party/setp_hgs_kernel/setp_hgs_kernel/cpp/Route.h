 ...
 * a route consists of one or more :class:`~setp_hgs_kernel._setp_hgs_kernel.Trip` objects.
 */
class Route
{
    using Client = size_t;
...
std::ostream &operator<<(std::ostream &out, setp_hgs_kernel::Route const &route);
