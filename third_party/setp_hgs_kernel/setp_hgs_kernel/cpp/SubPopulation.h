 ...
 * )
 *
 * Parameter configuration for the :class:`~setp_hgs_kernel.Population.Population`.
 *
 * Attributes
 * ----------
 * min_pop_size
 ...
 *     tournament. See :meth:`~setp_hgs_kernel.Population.Population.select` for details.
 * ub_diversity
