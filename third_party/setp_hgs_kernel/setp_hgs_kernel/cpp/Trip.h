 ...
 *    :class:`~setp_hgs_kernel._setp_hgs_kernel.Route`, which tracks overall route statistics
...
std::ostream &operator<<(std::ostream &out, setp_hgs_kernel::Trip const &trip);
