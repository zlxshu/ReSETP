...
using Route = setp_hgs_kernel::Route;
using Routes = std::vector<Route>;

namespace
{
// Angle of the given route w.r.t. the centroid of all client locations.
double routeAngle(setp_hgs_kernel::ProblemData const &data, Route const &route)
{
...
Routes sortByAscAngle(setp_hgs_kernel::ProblemData const &data, Routes routes)
{
...
setp_hgs_kernel::Solution setp_hgs_kernel::crossover::selectiveRouteExchange(
