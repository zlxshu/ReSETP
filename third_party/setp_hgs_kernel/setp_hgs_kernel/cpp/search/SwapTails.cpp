...
namespace
{
bool onLastTrip(setp_hgs_kernel::search::Route::Node *node)
{
...
setp_hgs_kernel::Cost SwapTails::evaluate(Route::Node *U,
                                Route::Node *V,
...
template <> bool setp_hgs_kernel::search::supports<SwapTails>(ProblemData const &data)
{
