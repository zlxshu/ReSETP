...
from setp_hgs_kernel.plotting.plot_coordinates import plot_coordinates
from setp_hgs_kernel.plotting.plot_demands import plot_demands
from setp_hgs_kernel.plotting.plot_time_windows import plot_time_windows
