...
class DepotSplit(NodeOperator):
    def __init__(
        self,
        data: ProblemData,
        compatible_vehicle_groups: list[int],
    ) -> None: ...
...
def insert_reload_cost(
    V: Node, depot: int, data: ProblemData, cost_evaluator: CostEvaluator
) -> int: ...
def insert_reload_feasible(V: Node, depot: int, data: ProblemData) -> bool: ...
def inplace_cost(
    U: Node, V: Node, data: ProblemData, cost_evaluator: CostEvaluator
) -> int: ...
def remove_cost(
