...
def _compute_proximity(
    ...
    -------
    np.ndarray[float]
        An array of size :py:attr:`~setp_hgs_kernel._setp_hgs_kernel.ProblemData.num_locations`
        by :py:attr:`~setp_hgs_kernel._setp_hgs_kernel.ProblemData.num_locations`.
