...
def _run_exact_epoch(
    ...
    *,
    ...
    max_no_improvement_iterations: int | None = None,
    ...
    if max_hgs_iterations is None:
        ...
        if (
            max_no_improvement_iterations is not None
            and max_no_improvement_iterations < 1
        ):
            raise ValueError(
                "max_no_improvement_iterations must be positive"
            )
        if (
        ...
        if max_no_improvement_iterations is not None:
            criteria.append(
                NoImprovement(int(max_no_improvement_iterations))
            )
    ...
    return HgsExactEpoch(
        ...
        stats={
            ...
            "max_no_improvement_iterations": (
                ...
                else int(max_no_improvement_iterations)
            ),
